          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                <div class="offcanvas-header">
                  <h3 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Precios</h3>
                </div>
                <div class="offcanvas-body">
                <form action="{{ route('comprador.vehiculosPorPrecio') }}" method="GET">
                      <div class="filtro-body">
                          <ul>
                              ...
                              <li><label for="max" class="form-label">Max</label>
                                  <input type="range" class="form-range" min="0" max="5000000" step="0.5" id="max">
          ...
          @if(isset($vehiculos) && count($vehiculos) > 0)
                    @foreach ($vehiculos as $vehiculo)
                        <tr>
                            ...
                            <td><a href="#">Información del vendedor</a></td>
                        </tr>
                    @endforeach
                @else
                    <tr>
